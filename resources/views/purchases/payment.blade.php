{{ Form::open(array('route' => array('purchases.payment.store', $purchase->id),'method'=>'post','enctype' => 'multipart/form-data', 'class' =>'needs-validation', 'novalidate')) }}
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::number('amount',$purchase->getDue(), array('class' => 'form-control','required'=>'required','min'=>'0','placeholder'=> __('Enter Amount'),'step'=>'0.01','max' => $purchase->getDue())) }}
            </div>
        </div>
