    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::number('amount',!empty($vendor->debit_note_balance)?$vendor->debit_note_balance:0, array('class' => 'form-control','required'=>'required','step'=>'0.01','placeholder'=>__('Enter Amount'))) }}{{--'min'=>'0',--}}
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
