...
<div>
    @permission('paysliptype create')
        <a  class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md" data-title="{{ __('Create Payslip Type') }}" data-url="{{route('payslip-type.create')}}" data-bs-toggle="tooltip"  data-bs-original-title="{{ __('Create') }}">
