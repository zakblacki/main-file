...
<div class="modal-body">
    <div class="row">
        <div class="col-md-12 mb-6">
            ...
            @if(check_file('uploads/sample/sample-attendance.csv'))
...
<div class="modal-footer">
    ...
    <a href="" data-url="{{ route('attendance.import.modal') }}" data-ajax-popup-over="true" title="{{ __('Create') }}" data-size="xl" data-title="{{ __('Import Attendance CSV Data') }}"  class="d-none import_modal_show"></a>
</div>
{{ Form::close() }}
<script>
