...
<div>
    @permission('terminationtype create')
        <a  class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md" data-title="{{ __('Create Termination Type') }}" data-url="{{route('terminationtype.create')}}" data-bs-toggle="tooltip" title="{{ __('Create') }}">
