            ...
            {{ Form::open(array('route' => 'footer_store', 'method'=>'post', 'enctype' => "multipart/form-data" , 'class'=>'needs-validation', 'novalidate' )) }}
                    <div class="border-bottom p-3 accordion-header">
                        <div class="row align-items-center">
                            ...
                            <div id="p1" class="col-auto text-end text-primary h3">
                                <a image-url="{{ asset('packages/workdo/LandingPage/src/Resources/assets/infoimages/footersection.png') }}"
        ...
        <div class="border mt-5">
            <div class="border-bottom p-3 accordion-header">
                <div class="row align-items-center">
                    ...
                    <div id="p1" class="col-auto text-end text-primary h3">
                        <a image-url="{{ asset('packages/workdo/LandingPage/src/Resources/assets/infoimages/footersection.png') }}" data-id="1"
                           data-url="{{ route('info.image.view',['landingpage','footer']) }}" class="view-images pt-2">
                            <i class="ti ti-info-circle pointer"></i>
                        </a>
                    </div>
